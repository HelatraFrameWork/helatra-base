 ...
 */
import { getValue, isUndefined, setValue, isNullOrUndefined, attributes, createElement } from '@helatra/base';
import { EventEmitter, EmbeddedViewRef, Renderer2, ElementRef, Directive } from '@angular/core';
...
export class ComponentBase<T> {
    ...
    public ngAfterViewInit(isTempRef?: any): void {
        ...
        const regExp: RegExp = /hel-tab|hel-accordion/g;
        /* istanbul ignore next */
    ...
    public ngOnDestroy(isTempRef?: any): void {
        ...
        /* istanbul ignore else  */
        setTimeout(() => {
            if (typeof window !== 'undefined' && tempOnDestroyThis.element && (tempOnDestroyThis.element.classList.contains('h-control'))) {
