                ...
                animeObj.animate(element, {
                    progress: (args: AnimationOptions): void => {
                        if (args.timeStamp > (args.delay + args.duration) / 2) {
                            animeAttr = args.element.getAttribute('h-animate');
                            done();
                        }
                    }
                });
    ...
    describe('stop animation at inprogress # ', () => {
        describe('with element # ', () => {
            ...
            beforeEach((done: () => void) => {
                animeObj.animate(element, {
                    progress: (args: AnimationOptions): void => {
                        animationId = args.element.getAttribute('h-animation-id');
        ...
        it('with out animate method # ', () => {
            let element: HTMLElement = createElement('div', {
                id: 'anime',
                attrs: { 'h-animate': 'true' }
            });
            Animation.stop(element);
            expect(element.getAttribute('h-animate')).toBeNull();
        });
    });
});
...
describe('Ripple Effect # ', () => {
    describe('without enableRipple #', () => {
        ...
        it('test h-ripple attribute on ripple element', () => {
            expect(rippleEffectElement.getAttribute('data-ripple')).toEqual(null);
            expect(rippleEffectElement.getElementsByClassName('h-ripple-element').length).toEqual(0);
        });
    ...
    describe('enable Ripple value is True # ', () => {
        ...
        it('test  h-ripple attribute on selector element', () => {
    ...
    describe('enable Ripple value is False and selector is Vaild Selector #', () => {
        ...
        describe('check ripple effect on valid selector # ', () => {
            ...
            it('test h-ripple attribute on selector element', () => {
                expect(apply.className.indexOf('h-ripple')).toEqual(-1);
                expect(apply.getElementsByClassName('h-ripple-element').length).toEqual(0);
            });
        });
        afterAll(() => {
    ...
    describe('enable Ripple value is False and selector is In-Vaild Selector #', () => {
        ...
        describe('check ripple effect on invalid selector # ', () => {
            ...
            it('test h-ripple attribute on selector element', () => {
                expect(ignore.className.indexOf('h-ripple')).toEqual(-1);
                expect(ignore.getElementsByClassName('h-ripple-element').length).toEqual(0);
            });
        });
        afterAll(() => {
            document.body.removeChild(rippleEffectElement);
    ...
    describe('enable Ripple value is True and selector is Vaild Selector #', () => {
        ...
        describe('check ripple effect on valid selector # ', () => {
            ...
            it('test h-ripple attribute on selector element', () => {
                expect(apply.className.indexOf('h-ripple')).not.toEqual(-1);
                expect(apply.getElementsByClassName('h-ripple-element').length).not.toEqual(0);
            });
        });
        afterAll(() => {
            document.body.removeChild(rippleEffectElement);
    ...
    describe('enable Ripple value is True and selector is In-Vaild Selector #', () => {
        ...
        describe('check ripple effect on invalid selector # ', () => {
            ...
            it('test h-ripple attribute on selector element', () => {
                expect(ignore1.className.indexOf('h-ripple')).toEqual(-1);
                expect(ignore1.getElementsByClassName('h-ripple-element').length).toEqual(0);
            });
        });
        afterAll(() => {
    ...
    describe('enable Ripple value is False and selector is Vaild Selector  and Ripple flag false #', () => {
        ...
        describe('check ripple effect on valid selector # ', () => {
            ...
            it('test h-ripple attribute on selector element', () => {
                expect(apply1.className.indexOf('h-ripple')).toEqual(-1);
                expect(apply1.getElementsByClassName('h-ripple-element').length).toEqual(0);
            });
        });
    });
    describe('enable Ripple value is False and selector is inVaild Selector  and Ripple flag true #', () => {
        ...
        describe('check ripple effect on invalid selector # ', () => {
            ...
            it('test h-ripple attribute on selector element', () => {
                expect(ignore2.className.indexOf('h-ripple')).toEqual(-1);
                expect(ignore2.getElementsByClassName('h-ripple-element').length).toEqual(0);
            });
        });
        afterAll(() => {
            document.body.removeChild(rippleEffectElement);
    ...
    describe('enable Ripple value is False and selector is inVaild Selector  and Ripple flag false #', () => {
        ...
        describe('check ripple effect on invalid selector # ', () => {
            ...
            it('test h-ripple attribute on selector element', () => {
                expect(ignore3.className.indexOf('h-ripple')).toEqual(-1);
                expect(ignore3.getElementsByClassName('h-ripple-element').length).toEqual(0);
            });
        });
        afterAll(() => {
            document.body.removeChild(rippleEffectElement);
    ...
    describe('enable Ripple value is true and selector is Vaild Selector  and Ripple flag false #', () => {
        ...
        describe('check ripple effect on valid selector # ', () => {
            ...
            it('test h-ripple attribute on selector element', () => {
                expect(apply2.className.indexOf('h-ripple')).toEqual(-1);
                expect(apply2.getElementsByClassName('h-ripple-element').length).toEqual(0);
            });
        });
        afterAll(() => {
            document.body.removeChild(rippleEffectElement);
    ...
    describe('enable Ripple value is true and selector is inVaild Selector  and Ripple flag true #', () => {
        ...
        describe('check ripple effect on invalid selector # ', () => {
            ...
            it('test h-ripple attribute on selector element', () => {
                expect(ignore6.className.indexOf('h-ripple')).toEqual(-1);
                expect(ignore6.getElementsByClassName('h-ripple-element').length).toEqual(0);
            });
        });
        afterAll(() => {
            document.body.removeChild(rippleEffectElement);
    ...
    describe('enable Ripple value is true and selector is inVaild Selector  and Ripple flag false #', () => {
        ...
        describe('check ripple effect on invalid selector # ', () => {
            ...
            it('test h-ripple attribute on selector element', () => {
                expect(ignore5.className.indexOf('h-ripple')).toEqual(-1);
                expect(ignore5.getElementsByClassName('h-ripple-element').length).toEqual(0);
            });
        });
        afterAll(() => {
            document.body.removeChild(rippleEffectElement);
    ...
    describe('check ripple animation # ', () => {
        ...
        it('test h-ripple attribute on ripple element', () => {
            expect(rippleEffectElement.getAttribute('data-ripple')).not.toEqual(null);
            expect(rippleEffectElement.getElementsByClassName('h-ripple-element').length).not.toEqual(0);
        });
    });
    ...
    describe('check ripple effect after destroy # ', () => {
        ...
        it('test h-ripple attribute on ripple element', () => {
            ...
            expect(rippleEffectElement1.getElementsByClassName('h-ripple-element').length).toEqual(0);
        });
    });
    ...
    describe('test ripple effect on edge browser', () => {
        ...
        it('test h-ripple attribute on ripple element', (done: Function) => {
            setTimeout(() => {
                expect(rippleEffectElement2.className.indexOf('h-ripple')).toEqual(-1);
                expect(apply.getElementsByClassName('h-ripple-element').length).toEqual(0);
                done();
            }, 400);
        });
    ...
    describe('ripple effect with center ripple option', () => {
        ...
        it('test ripple effect on ignoreed element', () => {
            expect(rippleEffectElement.className.indexOf('h-ripple')).not.toEqual(-1);
            expect(rippleEffectElement.getElementsByClassName('h-ripple-element').length).not.toEqual(0);
        });
        afterAll(() => {
            document.body.removeChild(rippleEffectElement);
