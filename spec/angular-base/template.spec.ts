...
describe('=> Template Component => ', () => {
    ...
    it('clear component all template', () => {
        let controlInstance: any = (el as any).querySelector('.h-control').hel_instances[0];
...
describe('=> Template Component => ', () => {
    ...
    beforeEach((done) => {
        ...
        TestBed.overrideComponent(TemplateApp, {
            set: {
                template: `<hel-list #comp [dataSource]='data' [template]='commonTemplate'></hel-list>
...
describe('=> String Template Component => ', () => {
    ...
    beforeEach((done) => {
        ...
        TestBed.overrideComponent(TemplateApp, {
            set: {
                template: `<hel-list [dataSource]='data' [template]='tmpl'>
    ...
    it('string template', () => {
        expect((el.querySelector('.h-control') as any).hel_instances[0].template).toBe('<div>dataCheck</div>');
    });
