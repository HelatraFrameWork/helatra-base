...
describe('KeyConfig', (): void => {
    describe('instance creation', () => {
        it('with default option', () => {
            ...
            expect(kbEvt.element.classList.contains('h-keyboard')).toEqual(true);
        });
        ...
        it('without default option', () => {
            ...
            expect(objKeyConfig.element.classList.contains('h-keyboard')).toEqual(true);
        })
    });
    describe('Action', () => {
        beforeAll(function () {
    ...
    describe('API/Method', () => {
        ...
        it('destroy class test', () => {
            expect(ele.classList.contains('h-keyboard')).toEqual(true);
            objKeyConfig.destroy();
            expect(ele.classList.contains('h-keyboard')).toEqual(false);
        });
    });
});
